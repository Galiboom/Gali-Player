...
export default function App() {
  ...
  const filteredTracks = useMemo(() => {
    ...
    return tracks.filter((track) =>
      [track.title, track.artist, track.album, track.mood].some((value) => value.toLowerCase().includes(keyword)),
    )
  }, [query])
  ...
  const completeLogin = (account) => {
    ...
    if (authForm.remember) {
      localStorage.setItem('gali-player-user', JSON.stringify(account))
    }
    setIsAuthOpen(false)
    setAuthError('')
  }
  ...
  const handleDemoLogin = () => {
    setAuthForm((current) => ({ ...current, ...demoAccount, password: 'gali2026' }))
  ...
  return (
    <main
      ...
      style={{
        ...
        '--current-accent': currentTrack.accent,
      }}
    >
        ...
        >
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              ...
              {!user && (
                <button className="ghost-button" onClick={() => setIsAuthOpen(true)}>
                  <User size={17} />
                  账号登录
                </button>
              )}
        ...
        <div className="controls">
          <div className="control-buttons">
            <button
              ...
              aria-label="随机播放"
              onClick={() => setIsShuffling((value) => !value)}
            >
              <Shuffle size={17} />
            </button>
        ...
        {isAuthOpen && (
          ...
          >
            ...
            >
              ...
              <button className="auth-close" type="button" onClick={() => setIsAuthOpen(false)}>
                稍后再说
              </button>
            </motion.form>
          </motion.div>
